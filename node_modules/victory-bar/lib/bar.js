...
var getBarPath = function (props, width, cornerRadius, barOffset) {
  if (props.getPath) {
    return (0, _pathHelperMethods.getCustomBarPath)(props, width);
  }

  return props.horizontal ? (0, _pathHelperMethods.getHorizontalBarPath)(props, width, cornerRadius, barOffset) : (0, _pathHelperMethods.getVerticalBarPath)(props, width, cornerRadius, barOffset);
};
...
var getBarOffset = function (barOffset, props) {
  return _victoryCore.Helpers.evaluateProp(barOffset, props);
};
...
var evaluateProps = function (props) {
  ...
  var barOffset = getBarOffset(props.barOffset, props);
...
var Bar = function (props) {
  ...
  var _props = props,
      ...
      barOffset = _props.barOffset;
  var path = polar ? getPolarBarPath(props, cornerRadius) : getBarPath(props, barWidth, cornerRadius, barOffset);
...
Bar.propTypes = _objectSpread({}, _victoryCore.CommonProps.primitiveProps, {
  ...
  barOffset: _propTypes.default.arrayOf(_propTypes.default.number),
